...
/// Hard-coded VM deploy table (IPs synced with live mesh 2026-09-11).
/// Override with <canonical-dir>/deploy.json if present.
const VM_DEPLOY_TABLE: []const VmDeployConfig = &[_]VmDeployConfig{
    .{ .hostname = "linuxvm", .target = "aarch64-linux-musl", .ip = "192.168.65.5", .user = "root", .password = "111", .remote_dir = "/opt/utmm" },
